import Worker from './text-decoding.worker'; // eslint-disable-line import/no-unresolved
 ...
 */
export default class TextDecodingPool extends Pool {
  constructor() {
    super(Worker);
  }
  ...
  async process(args) {
    ...
    return new Promise((resolve, reject) => {
      ...
      currentWorker.postMessage(['parseVlenUtf8', args], []);
    });
  }
}
