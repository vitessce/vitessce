...
import configSchema2_0_0 from '../schemas/config-2.0.0.schema.json';
...
export const SCHEMA_HANDLERS = {
  ...
  '2.0.0': [new Ajv().addSchema(cellSetsSchema).addSchema(rasterSchema).compile(configSchema2_0_0), null],
};
