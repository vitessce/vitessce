...
import configSchemaXAI from '../schemas/config-xai.schema.json';
 ...
 */
export const LATEST_VERSION = 'xai';
export const SCHEMA_HANDLERS = {
  ...
  xai: [new Ajv().addSchema(cellSetsSchema).addSchema(rasterSchema).compile(configSchemaXAI), null],
};
