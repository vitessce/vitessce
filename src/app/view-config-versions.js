...
import configSchemaNext from '../schemas/config-next.schema.json';
 ...
 */
export const LATEST_VERSION = 'next';
export const SCHEMA_HANDLERS = {
  ...
  next: [
    new Ajv().addSchema(cellSetsSchema).addSchema(rasterSchema).compile(configSchemaNext), null,
  ],
};
