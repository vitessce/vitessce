...
import configSchema1_1_0 from '../schemas/config-1.1.0.schema.json';
...
export const SCHEMA_HANDLERS = {
  ...
  '1.1.0': [new Ajv().addSchema(cellSetsSchema).addSchema(rasterSchema).compile(configSchema1_1_0), null],
};
