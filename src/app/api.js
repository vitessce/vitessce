...
export const configs = {
  'hubmap-kidney': {
    "version": "1.0.5",
    "name": "HuBMAP Dataset",
    "description": "SC-RNASEQ Dataset from Blue at UCSD",
    "datasets": [
      {
        ...
        "files": [
          {
            ...
            "url": "https://vitessce-demo-data.storage.googleapis.com/hubmap/Kidney_Healthy-Injury_Cell_Atlas_snCv3_Seurat_07302021.zarr",
            "options": {
              "mappings": {
                "UMAP": {
                  "key": "obsm/X_umap",
          ...
          },
          {
            ...
            "options": [
              {
                "groupName": "Subclass Full",
                "setName": "obs/subclass.full"
              },
              {
                "groupName": "Subclass Levels",
                "setName": ["obs/subclass.l1", "obs/subclass.l2", "obs/subclass.l3"]
              },
              {
                "groupName": "Subclass L1",
                "setName": "obs/subclass.l1"
              },
              {
                "groupName": "Subclass L2",
                "setName": "obs/subclass.l2"
              },
              {
                "groupName": "Subclass L3",
                "setName": "obs/subclass.l3"
              },
              {
                "groupName": "Region L1",
                "setName": "obs/region.l1"
              },
              {
                "groupName": "Region L2",
                "setName": "obs/region.l2"
              },
              {
                "groupName": "Condition Long",
                "setName": "obs/condition.long"
              }
            ]
          },
          {
