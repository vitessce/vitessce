...
const linnarssonBase = {
  ...
  layers: [
      ...
      .map(makeLayerNameToConfig('linnarsson')),
    {
      name: 'cell_sets',
      type: 'CELL_SETS',
      url: 'https://keller-mark.github.io/temp-vitessce-cell-sets/linnarsson.cell_sets.v25.json',
    },
  ],
};
...
const driesBase = {
  ...
  layers: [
    ...
    ].map(makeLayerNameToConfig('dries')),
    {
      name: 'cell_sets',
      type: 'CELL_SETS',
      url: 'https://keller-mark.github.io/temp-vitessce-cell-sets/dries.cell_sets.v25.json',
    },
  ],
};
