      ...
      files: [{
        ...
        options: {
          ...
          images: [{
            name: 'SIMPLE',
            type: 'ome-tiff',
            url: 'https://vitessce-demo-data.storage.googleapis.com/test-data/VAN0006-LK-2-85-IMS_PosMode_multilayer.pyramid.SIMPLE.ome.tiff',
            metadata: {
              isBitmask: false,
            },
          }],
      ...
      files: [{
        ...
        options: {
          ...
          images: [{
            name: 'GAUSSIAN',
            type: 'ome-tiff',
            url: 'https://vitessce-demo-data.storage.googleapis.com/test-data/VAN0006-LK-2-85-IMS_PosMode_multilayer.pyramid.GAUSSIAN.ome.tiff',
            metadata: {
              isBitmask: false,
            },
          }],
          renderLayers: ['GAUSSIAN'],
        },
      }],
    }, {
      uid: 'C',
      ...
      files: [{
        ...
        options: {
          ...
          images: [{
            name: 'AREA',
            type: 'ome-tiff',
            url: 'https://vitessce-demo-data.storage.googleapis.com/test-data/VAN0006-LK-2-85-IMS_PosMode_multilayer.pyramid.AREA.ome.tiff',
            metadata: {
              isBitmask: false,
            },
          }],
      ...
      files: [{
        ...
        options: {
          ...
          images: [{
            name: 'LINEAR',
            type: 'ome-tiff',
            url: 'https://vitessce-demo-data.storage.googleapis.com/test-data/VAN0006-LK-2-85-IMS_PosMode_multilayer.pyramid.LINEAR.ome.tiff',
            metadata: {
              isBitmask: false,
            },
          }],
