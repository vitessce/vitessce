...
export const CoordinationType = {
  ...
  SPATIAL_RASTER_CHANNEL: 'spatialRasterChannel',
  SPATIAL_RASTER_CHANNEL_VISIBLE: 'spatialRasterChannelVisible',
  SPATIAL_RASTER_MODEL_MATRIX: 'spatialRasterModelMatrix',
  SPATIAL_RASTER_COLOR: 'spatialRasterColor',
  SPATIAL_RASTER_COLORMAP: 'spatialRasterColormap',
  SPATIAL_RASTER_COLORMAP_RANGE: 'spatialRasterColormapRange',
  SPATIAL_RASTER_COLORMAP_SLIDER_RANGE_TYPE: 'spatialRasterColormapSliderRangeType',
  SPATIAL_RASTER_VOLUME_RENDERING_METHOD: 'spatialRasterVolumeRenderingMethod',
