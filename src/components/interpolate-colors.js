...
// The functions defined here have been adapted from d3-interpolate, d3-color, and d3-scale-chromatic.
// Color string "rgb(r,g,b)" representations are replaced by color array [r, g, b] representations,
// to allow them to work nicely with deck.gl,
// without the need to converting back and forth between formats.
