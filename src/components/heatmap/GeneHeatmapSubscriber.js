...
const GENE_HEATMAP_DATA_TYPES = [DataType.CELLS, DataType.CELL_SETS, DataType.EXPRESSION_MATRIX];
 ...
 */
export default function GeneHeatmapSubscriber(props) {
  const {
    uuid,
    coordinationScopes,
    ...
    title = `${capitalize(variablesLabel)} Expression Heatmap`,
  } = props;
  ...
  }] = useCoordination(COMPONENT_COORDINATION_TYPES[Component.GENE_HEATMAP], coordinationScopes);
