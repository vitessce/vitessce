 ...
 */
export default class HeatmapVerticalAxisLayer extends CompositeLayer {
  renderLayers() {
...
HeatmapVerticalAxisLayer.layerName = 'HeatmapVerticalAxisLayer';
HeatmapVerticalAxisLayer.defaultProps = defaultProps;
