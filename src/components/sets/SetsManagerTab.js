...
export default class SetsManagerTab extends React.Component {
  ...
  onExpand(expandedKeys) {
    ...
    // But, when autoExpandParent is set to true, a parent cannot be collapsed if there are expanded children.
    // So upon an expansion interaction, we always want autoExpandParent to be false so to allow
    // a parent with expanded children to collapse.
    this.setState({
      expandedKeys,
