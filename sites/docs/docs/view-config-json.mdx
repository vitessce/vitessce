...
import DiffViewConfigSchema from '../src/pages/_BrowserOnlyDiffViewConfigSchema';

## Overview

The Vitessce **view config** defines datasets (and the URLs to their associated data files) and views that will be used to visualize and interact with the data.
