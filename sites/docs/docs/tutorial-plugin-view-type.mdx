...
See the [view type implementation](/docs/dev-add-component/) and [plugin view type development](/docs/dev-plugins/#plugin-view-types) documentation for more details.
...
export default function MyApp() {
  return (
    <Vitessce config={configWithPluginViewType} height={800} theme="light" />
  );
}
```
