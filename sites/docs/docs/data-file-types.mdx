...
options={`{
  ...
  // For scCODA results, this column indicates the covariate value.
  // (This column may not be needed in the future, see https://github.com/keller-mark/compasce/issues/30)
