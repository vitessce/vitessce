...
See the [file type implementation](/docs/dev-add-loader/) and [plugin file type development](/docs/dev-plugins/#plugin-file-types) documentation for more details.
...
export default function MyApp() {
  return (
    <Vitessce config={configWithPluginFileType} height={800} theme="light" />
  );
}
```
