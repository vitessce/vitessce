...
function GitHubIcon(props) {
  ...
  return (
    <a href={`https://github.com/${siteConfig.organizationName}/`} target="_blank" rel="noopener noreferrer" className={clsx('ghLink', className)}>
      <span>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={clsx(styles.ghIcon, { ghDark: isDarkTheme, ghLight: !isDarkTheme })}>
