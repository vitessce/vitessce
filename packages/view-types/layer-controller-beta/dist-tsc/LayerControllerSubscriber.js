...
import { TitleInfo, useReady, useClosestVitessceContainerSize, useWindowDimensions, useCoordination, useLoaders, useAuxiliaryCoordination, useComponentLayout, useMultiObsSpots, useMultiObsPoints, useMultiObsSegmentations, useMultiImages, useMergeCoordination, useComplexCoordination, useMultiCoordinationScopesNonNull, useMultiCoordinationScopesSecondaryNonNull, useComplexCoordinationSecondary, useCoordinationScopes, useCoordinationScopesBy, } from '@vitessce/vit-s';
...
export function LayerControllerSubscriber(props) {
    const { coordinationScopes: coordinationScopesRaw, coordinationScopesBy: coordinationScopesByRaw, closeButtonVisible, downloadButtonVisible, removeGridComponent, theme, title = 'Spatial Layers', uuid, } = props;
    ...
    return (_jsx(TitleInfo, { title: title, isScroll: true, closeButtonVisible: closeButtonVisible, downloadButtonVisible: downloadButtonVisible, removeGridComponent: removeGridComponent, theme: theme, isReady: isReady, children: _jsx(LayerController, { theme: theme, coordinationScopesRaw: coordinationScopesRaw, segmentationLayerScopes: segmentationLayerScopes, segmentationLayerCoordination: segmentationLayerCoordination, segmentationChannelScopesByLayer: segmentationChannelScopesByLayer, segmentationChannelCoordination: segmentationChannelCoordination, images: imageData, imageLayerScopes: imageLayerScopes, imageLayerCoordination: imageLayerCoordination, targetT: targetT, targetZ: targetZ, setTargetT: setTargetT, setTargetZ: setTargetZ, spatialRenderingMode: spatialRenderingMode, setSpatialRenderingMode: setSpatialRenderingMode, imageChannelScopesByLayer: imageChannelScopesByLayer, imageChannelCoordination: imageChannelCoordination, spotLayerScopes: spotLayerScopes, spotLayerCoordination: spotLayerCoordination, pointLayerScopes: pointLayerScopes, pointLayerCoordination: pointLayerCoordination }) }));
}
