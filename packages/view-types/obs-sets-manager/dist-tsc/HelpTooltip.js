...
export default function HelpTooltip(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("span", { ref: spanRef }), _jsx(RcTooltip, { ...props, getTooltipContainer: getTooltipContainer, overlayClassName: classes[overlayClassName], overlay: overlay })] }));
}
