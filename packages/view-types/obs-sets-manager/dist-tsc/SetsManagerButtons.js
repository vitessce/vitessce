...
import { handleImportJSON, handleImportTabular, MIME_TYPE_JSON, MIME_TYPE_TABULAR, } from '@vitessce/sets-utils';
...
export function PlusButton(props) {
    ...
    return (menuConfig.length > 0 ? (_jsx(PopoverMenu, { menuConfig: menuConfig, children: _jsx("button", { className: classes.plusButton, type: "submit", children: "+" }) })) : null);
}
/**
...
export function SetOperationButtons(props) {
    const { onUnion, onIntersection, onComplement, operatable, hasCheckedSetsToUnion, hasCheckedSetsToIntersect, hasCheckedSetsToComplement, } = props;
    return (_jsx(_Fragment, { children: operatable && (_jsxs(_Fragment, { children: [_jsx("button", { onClick: onUnion, title: "New set from union of checked sets", type: "submit", disabled: !hasCheckedSetsToUnion, children: _jsx(SetUnionSVG, {}) }), _jsx("button", { onClick: onIntersection, title: "New set from intersection of checked sets", type: "submit", disabled: !hasCheckedSetsToIntersect, children: _jsx(SetIntersectionSVG, {}) }), _jsx("button", { onClick: onComplement, title: "New set from complement of checked sets", type: "submit", disabled: !hasCheckedSetsToComplement, children: _jsx(SetComplementSVG, {}) })] })) }));
}
