// Volume rendering vertex shader for GPU-accelerated ray casting
// This shader prepares data for rendering 3D volumetric data (medical imaging, scientific visualizations)
//
// ============================================================================
