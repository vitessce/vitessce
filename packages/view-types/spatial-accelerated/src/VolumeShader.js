...
export const VolumeShader = {
  uniforms: {
    ...
    resGlobal: { value: new Vector2(3, 5) },
    res0: { value: new Vector2(3, 5) },
    res1: { value: new Vector2(1, 5) },
    res2: { value: new Vector2(1, 5) },
    res3: { value: new Vector2(1, 5) },
    res4: { value: new Vector2(0, 5) },
    res5: { value: new Vector2(0, 5) },
    res6: { value: new Vector2(0, 5) },
    maxChannels: { value: 0 },
    lodFactor: { value: 8.0 },
    near: { value: 0.1 },
    far: { value: 10000 },
