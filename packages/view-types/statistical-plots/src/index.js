export {
  ...
  register as registerCellSetExpression,
} from './CellSetExpressionPlotSubscriber';
export {
  CellSetSizesPlotSubscriber,
  register as registerCellSetSizes,
} from './CellSetSizesPlotSubscriber';
export {
  ExpressionHistogramSubscriber,
  register as registerExpressionHistogram,
} from './ExpressionHistogramSubscriber';
