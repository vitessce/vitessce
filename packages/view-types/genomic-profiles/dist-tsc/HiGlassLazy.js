...
export default function HiGlassLazy(props) {
    const { coordinationScopes, theme, hgViewConfig: hgViewConfigProp, hgOptions: hgOptionsProp, genomeSize, height, } = props;
    ...
    return (_jsxs("div", { className: classes.higlassWrapperParent, children: [_jsx("link", { rel: "stylesheet", type: "text/css", href: HIGLASS_CSS_URL }), _jsx("div", { className: classes.higlassWrapper, ref: containerRef, style: { height: `${height}px` }, children: _jsx(Suspense, { fallback: _jsx("div", { children: "Loading..." }), children: _jsx(LazyHiGlassComponent, { ref: setHgInstance, zoomFixed: false, viewConfig: hgViewConfig, options: hgOptions }) }) })] }));
}
