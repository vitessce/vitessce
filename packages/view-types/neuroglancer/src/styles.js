...
export const useStyles = makeStyles(theme => ({
  neuroglancerWrapper: {
    ...
    ...prependGlobalPrefix({
        ...
        ".CodeMirror-lines": { padding: "4px 0", cursor: "text", minHeight: "1px" },
        ...
        "@-moz-keyframes blink": { "50%": { backgroundColor: "transparent" } },
        "@-webkit-keyframes blink": { "50%": { backgroundColor: "transparent" } },
        ...
        ".cm-searching": { backgroundColor: ["#ffa", "#ff06"] },
        ...
        ".neuroglancer-state-editor": { width: "80%" },
