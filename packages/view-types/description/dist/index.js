...
import { useLoaders, useCoordination, useDescription, useImageData, useReady, TitleInfo } from "@vitessce/vit-s";
...
function Description(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.description, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: description }),
    metadata && Array.from(metadata.entries()).map(([layerIndex, { name: layerName, metadata: metadataRecord }]) => metadataRecord && Object.entries(metadataRecord).length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { children: layerName }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.metadataContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsx("table", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: Object.entries(metadataRecord).map(([key, value]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { title: key, children: key }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { title: value, children: value })
      ] }, key)) }) }) })
    ] }, layerIndex) : null)
  ] });
}
