...
export function EnhancedRayGrab(props) {
    const { onSelectStart, onSelectEnd, children, ...rest } = props;
    ...
    return (_jsx(Interactive, { ref: groupRef, onSelectStart: handleSelectStart, onBlur: handleSelectEnd, onSelectEnd: handleSelectEnd, ...rest, children: children }));
}
