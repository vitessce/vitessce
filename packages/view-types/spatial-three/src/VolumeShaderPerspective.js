...
export const VolumeRenderShaderPerspective = {
  ...
  fragmentShader: [
    ...
    // "  fragColor = vec4(worldSpaceCoords.x,worldSpaceCoords.y,worldSpaceCoords.z,0.5);",
    // "  return;",
    //
    ...
    '  vec3 meshPos = texture(u_stop_geom, vec2(x,y)).xyz;',
    // "  vec3 meshPos = texture(u_stop_geom, vec2(gl_FragCoord.x,gl_FragCoord.y)).xyz;",
    //  "  fragColor = vec4(meshPos,1.0);",
    //  "  return;",
    '  float dist = 1000.0;',
    ...
    '           fragColor.a += (1.0 - fragColor.a) * val_color.a * dtScale;',
    '           if (fragColor.a >= 0.95) {',
    '               break;',
    '           }',
    '       }',
