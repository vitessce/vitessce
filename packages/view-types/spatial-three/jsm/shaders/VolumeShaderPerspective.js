...
var VolumeRenderShaderPerspective = {
    ...
    vertexShader: [
        ...
        "varying vec2 vUv;",
        "varying mat4 out_projectionMatrix;",
        "varying mat4 out_viewMatrix;",
        "void main()",
        "{",
        ...
        "   out_projectionMatrix = projectionMatrix;",
        "   out_viewMatrix = viewMatrix;",
        "}"
    ].join("\n"),
    fragmentShader: [
        "#include <packing>",
        ...
        "  float depthIn = readDepth(u_stop_geom, vec2(x,y));",
        //"  gl_FragColor = vec4(result,result,result,0.0);",
        //"  return;",
        "  for (float t = t_hit.x; t < t_hit.y; t += dt) {",
        "      vec4 depth_vec = out_viewMatrix * out_projectionMatrix * vec4(p.xyz, 1.0);",
