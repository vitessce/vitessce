...
var VolumeRenderShaderPerspective = {
    ...
    fragmentShader: [
        ...
        "           gl_FragColor = vec4(val_color.rgb,1.0);",
        "           break;",
        "       }",
        ...
        "       vec4 val_color = texture2D(u_geo_color, vec2(x,y));",
        "       gl_FragColor.a = max(1.0,val_color.a + gl_FragColor.a);",
        "       gl_FragColor.rgb = val_color.rgb + gl_FragColor.rgb;",
        "   }",
