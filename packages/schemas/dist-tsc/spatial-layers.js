import { z } from 'zod';
export const imageLayerObj = z.array(z.object({
    channels: z.array(z.object({
        color: z.array(z.number())
            .describe('The color to use when rendering this channel under the null colormap.')
            .optional(),
        selection: z.record(z.any())
            .describe('Determines the channel selection, e.g. some Z and time slice.'),
        slider: z.array(z.number())
            .describe('Determines the range for color mapping.')
            .optional(),
        visible: z.boolean()
            .describe('Determines whether this channel of the layer will be rendered in the spatial component.')
            .optional(),
    })
        .strict()),
    colormap: z.string()
    ...
    index: z
        .number()
        .describe('The index of the layer among the array of layers available in the image file.'),
    opacity: z.number(),
    ...
    domainType: z.enum(['Full', 'Min/Max'])
        .describe('Determines the extent of the channel slider input element in the layer controller.')
        .optional(),
    resolution: z.number()
    ...
    visible: z
        .boolean()
        .describe('Determines whether this entire layer will be rendered in the spatial component.')
        .optional(),
})
    .strict()
    .describe('The properties of this object are the rendering settings for the raster layer.'));
