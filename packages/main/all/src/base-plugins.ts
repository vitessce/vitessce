...
export const baseFileTypes = [
  ...
  makeFileType(FileType.OBS_BINS_IMAGE_SPATIALDATA_ZARR, DataType.OBS_BINS, SpatialDataObsBinsLoader, SpatialDataShapesSource, obsBinsSpatialdataSchema),
  makeFileType(FileType.OBS_BINS_SHAPES_SPATIALDATA_ZARR, DataType.OBS_BINS, SpatialDataObsBinsLoader, SpatialDataShapesSource, obsBinsSpatialdataSchema),
