...
export default function Legend(props) {
    ...
    const visible = (visibleProp && ((!considerSelections || (obsColorEncoding === 'geneSelection'
        && featureSelection
    ...
    useEffect(() => {
        ...
        const featureSelectionLabel = (featureSelection
            && featureSelection.length >= 1
            && !isStaticColor)
    ...
    return (_jsx("div", { className: clsx(classes.legend, {
