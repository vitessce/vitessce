...
export default function MultiLegend(props) {
    const { theme, 
    // Segmentations
    segmentationLayerScopes, segmentationLayerCoordination, segmentationChannelScopesByLayer, segmentationChannelCoordination, segmentationMultiExpressionExtents, 
    // Spots
    spotLayerScopes, spotLayerCoordination, spotMultiExpressionExtents, spotMultiFeatureLabels, 
    // Points
    pointLayerScopes, pointLayerCoordination, } = props;
    ...
    return (_jsxs("div", { className: classes.multiLegend, children: [pointLayerScopes ? reversedPointLayerScopes.flatMap((layerScope) => {
                ...
                return spatialLayerVisible && legendVisible ? (_jsx(Legend, { positionRelative: true, highContrast: true, showObsLabel: true, visible: spatialLayerVisible, theme: theme, obsType: obsType, featureType: featureType, featureValueType: featureValueType, obsColorEncoding: obsColorEncoding, spatialLayerColor: spatialLayerColor, featureSelection: null, 
                    // featureLabelsMap={featureLabelsMap} // TODO
                    featureValueColormap: "viridis", featureValueColormapRange: [0, 1], extent: null, height: height }, layerScope)) : null;
                ...
                return spatialLayerVisible && legendVisible ? (_jsx(Legend, { positionRelative: true, highContrast: true, showObsLabel: true, visible: spatialLayerVisible, theme: theme, obsType: obsType, featureType: featureType, featureValueType: featureValueType, obsColorEncoding: obsColorEncoding, spatialLayerColor: spatialLayerColor, featureSelection: featureSelection, featureLabelsMap: featureLabelsMap, featureValueColormap: featureValueColormap, featureValueColormapRange: featureValueColormapRange, extent: firstExpressionExtent, height: height, obsSetSelection: obsSetSelection, obsSetColor: obsSetColor }, layerScope)) : null;
                ...
                return (channelCoordination && channelScopes ? reversedChannelScopes.map((cScope) => {
                    ...
                    const height = isStaticColor ? 20 : 36;
                    return spatialLayerVisible && spatialChannelVisible && legendVisible ? (_jsx(Legend, { positionRelative: true, highContrast: true, showObsLabel: true, visible: spatialLayerVisible && spatialChannelVisible, theme: theme, obsType: obsType, featureType: featureType, featureValueType: featureValueType, obsColorEncoding: obsColorEncoding, featureSelection: featureSelection, 
                        // featureLabelsMap={featureLabelsMap} // TODO
                        featureValueColormap: featureValueColormap, featureValueColormapRange: featureValueColormapRange, extent: firstExpressionExtent, height: height, spatialChannelColor: spatialChannelColor, obsSetSelection: obsSetSelection, obsSetColor: obsSetColor }, `${layerScope}-${cScope}`)) : null;
                }) : null);
            }) : null] }));
}
