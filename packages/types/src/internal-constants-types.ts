...
export interface AsyncFunctionTypeCurr {
...
export interface CoordinationTypeCurr {
...
export interface StatusTypeCurr {
    LOADING: 'loading',
    SUCCESS: 'success',
    ERROR: 'error',
}
