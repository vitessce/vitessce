 ...
 * @param props.info - The info text to display.
 * @param props.placement - The placement of the overlay within its container.
 *   Defaults to 'bottom-end'. Supports all concrete Popper.js placements.
 * @returns A JSX element representing the info overlay.
 */
export function InfoOverlay({ info, placement = 'bottom-end' }: InfoOverlayProps) {
