...
function flipPlacement(placement: Placement, theme?: Theme): Placement {
...
type AnchorElType = null | Element | ((element: Element) => Element);

function getAnchorEl(anchorEl: AnchorElType): Element | null {
...
export const Popper = React.forwardRef<HTMLDivElement, PopperProps>(
   ...
   */
    ...
    const handleOpen = React.useCallback(() => {
      ...
      const handlePopperUpdate = (data: Data) => {
      ...
      if (process.env.NODE_ENV !== 'production') {
        if (resolvedAnchorEl && (resolvedAnchorEl as HTMLElement).nodeType === 1) {
          const box = (resolvedAnchorEl as HTMLElement).getBoundingClientRect();
