...
export const FILE_TYPE_DATA_TYPE_MAPPING = {
  ...
  [FileType.FEATURE_ANNOTATIONS_ANNDATA_ZARR]: DataType.FEATURE_ANNOTATION,
...
export const ALT_ZARR_STORE_TYPES = {
  ...
  [FileType.FEATURE_ANNOTATIONS_ANNDATA_ZARR]: {
    zip: FileType.FEATURE_ANNOTATIONS_ANNDATA_ZARR_ZIP,
    h5ad: FileType.FEATURE_ANNOTATIONS_ANNDATA_H5AD,
  },
