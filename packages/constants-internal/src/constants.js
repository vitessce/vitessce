...
export const CoordinationType = {
  ...
  SPATIAL_IMAGE_LAYER_ARRAY: 'spatialImageLayerArray',
  SPATIAL_SEGMENTATION_LAYER: 'spatialSegmentationLayer',
  SPATIAL_SEGMENTATION_LAYER_ARRAY: 'spatialSegmentationLayerArray',
  SPATIAL_POINT_LAYER: 'spatialPointLayer',
  SPATIAL_POINT_LAYER_ARRAY: 'spatialPointLayerArray',
  ...
  SPATIAL_IMAGE_CHANNEL_ARRAY: 'spatialImageChannelArray',
