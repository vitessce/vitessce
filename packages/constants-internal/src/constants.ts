...
export const CoordinationType = {
  ...
  SPATIAL_SCALE_X: 'spatialScaleX',
  SPATIAL_SCALE_Y: 'spatialScaleY',
  SPATIAL_SCALE_Z: 'spatialScaleZ',
  SPATIAL_SCENE_ROTATION_X: 'spatialSceneRotationX',
  SPATIAL_SCENE_ROTATION_Y: 'spatialSceneRotationY',
  SPATIAL_SCENE_ROTATION_Z: 'spatialSceneRotationZ',
  SPATIAL_SCENE_SCALE_X: 'spatialSceneScaleX',
  SPATIAL_SCENE_SCALE_Y: 'spatialSceneScaleY',
  SPATIAL_SCENE_SCALE_Z: 'spatialSceneScaleZ',
  SPATIAL_MATERIAL_BACKSIDE: 'spatialMaterialBackside',
