...
describe('loaders/ObsFeatureMatrixAnndataLoader', () => {
    Object.entries({ 0.7: [anndata_0_7_DenseFixture, anndata_0_7_CsrFixture, anndata_0_7_CscFixture], 0.8: [anndata_0_8_DenseFixture, anndata_0_8_CsrFixture, anndata_0_8_CscFixture], 0.9: [anndata_0_9_DenseFixture, anndata_0_9_CsrFixture, anndata_0_9_CscFixture], '0.10': [anndata_0_10_DenseFixture, anndata_0_10_CsrFixture, anndata_0_10_CscFixture] }).forEach(([version, fixtures]) => {
        describe(`AnnData v${version}`, () => {
            ...
            const loaderCsr = createAnndataLoader(`@fixtures/zarr/anndata-${version}/anndata-csr${version !== '0.7' ? '.adata' : ''}.zarr`, csrFixture);
            const loaderDense = createAnndataLoader(`@fixtures/zarr/anndata-${version}/anndata-dense.zarr`, denseFixture);
            const loaderCsc = createAnndataLoader(`@fixtures/zarr/anndata-${version}/anndata-csc.zarr`, cscFixture);
            ...
            it('loadCellXGene matches across dtypes', async () => {
                ...
                const getDataFromDtype = async (dtype) => {
                    const loaderCsrDtype = createAnndataLoader(`@fixtures/zarr/anndata-${version}/anndata-csr${version !== '0.7' ? '.adata' : ''}.zarr`, csrFixture, `layers/${dtype}`);
                    const loaderDenseDtype = createAnndataLoader(`@fixtures/zarr/anndata-${version}/anndata-dense.zarr`, denseFixture, `layers/${dtype}`);
                    const loaderCscDtype = createAnndataLoader(`@fixtures/zarr/anndata-${version}/anndata-csc.zarr`, cscFixture, `layers/${dtype}`);
