...
export function expandAnndataZarr(fileDef) {
  ...
  return [
    ...
    ...(options.obsEmbedding
      ? Array.isArray(options.obsEmbedding)
        ? options.obsEmbedding.map(oe => ({
    ...
    // eslint-disable-next-line no-nested-ternary
    ...(options.obsLabels
      ? Array.isArray(options.obsLabels)
        ? options.obsLabels.map(ol => ({
    ...
    ...(options.featureLabels
      ? Array.isArray(options.featureLabels)
        ? options.featureLabels.map(fl => ({
        ...
        : [
          {
            ...
            coordinationValues: {
              featureType: baseFileDef.coordinationValues.featureType,
              featureLabelsType:
                  baseFileDef.coordinationValues.featureLabelsType,
            },
          },
        ]
      : []),
