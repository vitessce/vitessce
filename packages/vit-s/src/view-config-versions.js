...
export const SCHEMA_HANDLERS = {
  ...
  '1.0.0': [
    new Ajv()
      .addSchema(obsSetsSchema)
      .addSchema(rasterSchema)
      .compile(configSchema1_0_0),
    upgradeFrom1_0_0,
  ],
  '1.0.1': [
    new Ajv()
