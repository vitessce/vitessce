...
export function removeImageChannelInMetaCoordinationScopesHelper(coordinationScopesRaw, layerScope, channelScope, coordinationSpace) {
    ...
    const channelMetaScopeBy = getMetaScopeBy(coordinationScopesRaw, coordinationSpace, CoordinationType.IMAGE_LAYER, CoordinationType.IMAGE_CHANNEL, layerScope);
    ...
    const prevChannels = hasPerLayerChannels
        ...
        ?.[channelMetaScopeBy]?.[CoordinationType.IMAGE_LAYER]?.[CoordinationType.IMAGE_CHANNEL]?.[layerScope]
        : metaCoordinationScopes // Fallback case.
        ?.[channelMetaScope]?.[CoordinationType.IMAGE_CHANNEL];
