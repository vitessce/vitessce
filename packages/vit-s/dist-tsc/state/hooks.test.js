...
import { getParameterScope, getParameterScopeBy, getScopes, getScopesBy, } from './hooks.js';
describe('vit-s/state/hooks.js', () => {
    describe('getParameterScope', () => {
        it('works', () => {
            expect(getParameterScope('obsType', {
                obsType: 'A',
            })).toEqual('A');
        });
    });
    describe('getParameterScopeBy', () => {
        it('works', () => {
            expect(getParameterScopeBy('spatialTargetC', 'spatialSegmentationLayer', 'glomerulus', {
