 ...
 * @returns {string} The new scope name.
 */
export function getNextScopeNumeric(prevScopes) {
    let nextScopeInt = 0;
    let nextScopeStr;
    do {
 ...
 */
export function createPrefixedGetNextScopeNumeric(prefix) {
    return (prevScopes) => {
        let nextScopeInt = 0;
        let nextScopeStr;
        do {
 ...
 */
export function getInitialCoordinationScopePrefix(datasetUid, dataType) {
 ...
 */
export function getInitialCoordinationScopeName(datasetUid, dataType, i = null) {
