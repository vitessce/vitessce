...
import { HIERARCHICAL_SCHEMAS, TABULAR_SCHEMAS, MIME_TYPE_JSON, MIME_TYPE_TABULAR, SEPARATOR_TABULAR, NA_VALUE_TABULAR, } from './constants.js';
/**
...
export function handleImportTabular(result, datatype, theme) {
    ...
    const importData = dsvParser.parse(result, row => ({
        ...
        obsId: row.obsId,
        predictionScore: ((isNil(row.predictionScore)
