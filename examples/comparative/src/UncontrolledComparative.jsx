...
function UncontrolledComparativeInner(props) {
  ...
  const [geneSelection, setGeneSelection] = useQueryState('gene', parseAsArrayOf(parseAsString));
  const [sampleSetSelection, setSampleSetSelection] = useQueryState('groups', parseAsArrayOf(parseAsString));
