...
function PluginImageViewSubscriber(props) {
    const { removeGridComponent, theme, title = 'Figure', imgSrc, imgAlt, } = props;
    return (_jsx(TitleInfo, { title: title, theme: theme, removeGridComponent: removeGridComponent, isReady: true, children: _jsx("img", { src: imgSrc, alt: imgAlt }) }));
}
export const pluginImageViewProps = {
    pluginViewTypes: [
        new PluginViewType('staticImage', PluginImageViewSubscriber, []),
    ],
};
