...
function generateImsConfig() {
    ...
    const [targetC1Scope, targetC2Scope, channelColor1Scope, channelColor2Scope, channelVisible1Scope, channelVisible2Scope, channelOpacity1Scope, channelOpacity2Scope, channelWindow1Scope, channelWindow2Scope,] = config.addCoordination('spatialTargetC', 'spatialTargetC', 'spatialChannelColor', 'spatialChannelColor', 'spatialChannelVisible', 'spatialChannelVisible', 'spatialChannelOpacity', 'spatialChannelOpacity', 'spatialChannelWindow', 'spatialChannelWindow');
    ...
    config.layout(vconcat(hconcat(spatialViewSimple, spatialViewGaussian, spatialViewArea, spatialViewLinear), hconcat(lcViewSimple, lcViewGaussian, lcViewArea, lcViewLinear)));
