...
function generateKpmpConfig() {
    ...
    const [featureTypeScope, featureValueScope, opacityScope, filledScope, strokeScope,] = config.addCoordination('featureType', 'featureValueType', 'spatialChannelOpacity', 'spatialSegmentationFilled', 'spatialSegmentationStrokeWidth');
