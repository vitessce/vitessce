import { VitessceConfig, CoordinationLevel as CL, } from '@vitessce/config';
function generateBloodVesselConfig() {
    ...
    const [glomsObsTypeScope, glomsFeatureTypeScope, glomsFeatureValueTypeScope, glomsFeatureSelectionScope,] = config.addCoordination('obsType', 'featureType', 'featureValueType', 'featureSelection');
