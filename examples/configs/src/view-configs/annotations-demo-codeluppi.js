  ...
  coordinationSpace: {
    ...
    annotationFrames: { A: [
...

      {
        ...
        text: 'The Oligodendrocyte subclusters are highlighted via obsSetSelection. All other cells are dimmed.',
        shapes: [
          {
      ...
      // ── Frame 5 ─────────────────────────────────────────────────────────
      // All three views with shapes simultaneously in one frame.
      {
        uid: 'frame-5',
        title: 'All Views Simultaneously — One Frame, Three Targets',
        text: 'A single annotation frame drives all three views at once. Yellow shapes appear in the spatial view, blue in t-SNE, and green in PCA. Each view renders only the shapes addressed to it.',
        shapes: [
          {
