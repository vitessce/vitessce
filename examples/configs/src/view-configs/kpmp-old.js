      ...
      files: [
        {
          ...
          url: 'http://localhost:8000/OME-TIFF/18-142_PAS_1of6.pyramid.ome.tif',
          options: {
            offsetsUrl: 'http://localhost:8000/OME-TIFF/18-142_PAS_1of6.pyramid.offsets.json',
          },
          coordinationValues: {
        ...
        },
        {
          ...
          url: 'http://localhost:8000/OME-TIFF/18-142_PAS_1of6_bf.ome.tif',
          options: {
            offsetsUrl: 'http://localhost:8000/OME-TIFF/18-142_PAS_1of6_bf.offsets.json',
          },
          coordinationValues: {
        ...
        },
        {
          ...
          url: 'http://localhost:8000/OME-TIFF/fake_glom_info.csv',
          coordinationValues: {
            obsType: 'Glomeruli',
            featureType: 'feature',
        ...
        {
          fileType: 'obsFeatureMatrix.csv',
          url: 'http://localhost:8000/OME-TIFF/fake_tub_info.csv',
          coordinationValues: {
            obsType: 'Tubules',
            featureType: 'feature',
            featureValueType: 'value',
