            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><ul>
                        ...
                        <li><a href={useBaseUrl('/docs/data-file-types/#genesjson')}><code>genes.json</code></a></li></ul></td>
                    <td><ul>
                        <li><a href={useBaseUrl('/docs/data-file-types/#anndata-as-h5ad')}>AnnData</a></li>
                        <li><a href={useBaseUrl('/docs/data-file-types/#loom')}>Loom</a></li>
                        <li><a href={useBaseUrl('/docs/data-file-types/#seurat')}>Seurat</a></li>
                ...
                <tr>
                    ...
                    <td><ul><li><a href={useBaseUrl('/docs/data-file-types/#neighborhoodsjson')}><code>neighborhoods.json</code></a></li></ul></td>
                    <td></td>
                </tr>
                <tr>
