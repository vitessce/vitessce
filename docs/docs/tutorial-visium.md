...
This download a new file called `.zgroup` to your Downloads folder.
...
We know that we want to visualize cell-level observations in scatterplots displaying the PCA and UMAP dimensionality reductions (which we computed with Scanpy earlier).
...
The strings `"ET1"` and `"ET2"` above are arbitrary names for the two coordination scopes.
        ...
        },
        {
          ...
          "options": {
            ...
            "images": [
              {
                "name": "H&E Image",
                "url": "https://s3.amazonaws.com/vitessce-data/0.0.32/master_release…e_10x.h5ad.zarr/uns/spatial/V1_Human_Lymph_Node/images/hires",
                "type": "zarr",
                "metadata": {
                  "isPyramid": false,
                  "transform": {
