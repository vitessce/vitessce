...
:::caution
The Zarr file types are not yet compatible with the Vitessce R package because [Zarr is not yet supported in R](https://github.com/vitessce/vitessceR/issues/7).
:::
