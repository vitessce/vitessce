...
[MuData](https://github.com/PMBio/mudata) is the multi-modal generalization of AnnData.
See the [AnnData as Zarr](#anndata-as-zarr) section for more information.

#### `mudata-cells.zarr`

#### `mudata-cell-sets.zarr`
...
Use AnnData's [`read_h5ad`](https://anndata.readthedocs.io/en/latest/generated/anndata.read_h5ad.html) function to load the file as an AnnData object, then use the [`.write_zarr`](https://anndata.readthedocs.io/en/latest/anndata.AnnData.write_zarr.html) function to convert to a Zarr store. 
...
Use AnnData's [`read_loom`](https://anndata.readthedocs.io/en/latest/generated/anndata.read_loom.html) function to load the Loom file as an AnnData object, then use the [`.write_zarr`](https://anndata.readthedocs.io/en/latest/anndata.AnnData.write_zarr.html) function to convert to a Zarr store. 
...
Use MuData's [`read_h5mu`](https://mudata.readthedocs.io/en/latest/api/generated/mudata.read_h5mu.html) function to load the file as an AnnData object, then use the [`.write_zarr`](https://mudata.readthedocs.io/en/latest/api/generated/mudata.write_zarr.html) function to convert to a Zarr store. 

```python
from mudata import read_h5mu
import zarr

mdata = read_h5mu('path/to/my_dataset.h5mu')
mdata.write_zarr('my_store.zarr')
```

Converted outputs can be used with the [MuData as Zarr](#mudata-as-zarr) family of native file types.
