...
json={`
{
  ...
  "fileType": "anndataObsFeatureMatrix.zarr",
  "options": {
    "matrix": "X"
  }
}
...
const dataset = vc
  ...
  .addFile(
    ...
    ft.ANNDATA_OBS_FEATURE_MATRIX_ZARR,
    null,
    options
  );
`}
...
json={`
{
  ...
  "dataType": "obsFeatureMatrix",
  "fileType": "expressionMatrix.zarr"
}
`}
js={`
const dataset = vc
