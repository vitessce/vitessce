...
import DemoList from '../src/pages/_DemoList';
...
<img style={{ width: '100%' }} src="/img/blog/fig1_argelaguet_2021.png" alt="Figure 1, Argelaguet et al., Nature Biotechnology 2021"/>
...
We hope that these changes make it easier to configure, [prepare data](/docs/data-file-types/), and [develop plugins](/docs/dev-plugins/) for Vitessce.
...
<div className="obsFeatureDemoGrid">
  <div className="obsFeatureDemoGridItem">
    <a className="obsFeatureDemoGridItemTitle">Codeluppi et al., Nature Methods 2018</a>
    <p className="obsFeatureDemoGridItemDescription">Spatial organization of the somatosensory cortex revealed by osmFISH</p>
    <span className="pill spatial">spatial</span>
    <span className="pill csv">CSV</span>
  </div>
  <div className="obsFeatureDemoGridItem">
    <a className="obsFeatureDemoGridItemTitle">Codeluppi et al., Nature Methods 2018</a>
    <p className="obsFeatureDemoGridItemDescription">Spatial organization of the somatosensory cortex revealed by osmFISH</p>
    <span className="pill spatial">spatial</span>
    <span className="pill zarr">Zarr</span>
    <span className="pill anndata">AnnData</span>
  </div>
  <div className="obsFeatureDemoGridItem">
    <a className="obsFeatureDemoGridItemTitle">Human lymph node, 10X Visium</a>
    <p className="obsFeatureDemoGridItemDescription">3,861 spots</p>
    <span className="pill spatial">spatial</span>
    <span className="pill zarr">Zarr</span>
    <span className="pill anndata">AnnData</span>
  </div>
...
The remaining sections are meant for developers looking to make existing code compatible with the latest version of the `vitessce` JavaScript package and the FOM paradigm.
...
We will now work to update the Python and R code to release new Python and R package versions.
