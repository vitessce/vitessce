...
The [constructor](/docs/view-config-js/#constructor-schemaversion-name-description-) now accepts named arguments via an object.
...
Now, the coordination types `obsType` and `featureType` should be used for this purpose instead.
Existing view configs (version `1.0.14` and below) will be automatically upgraded, replacing the props usage with coordination usage.
