...
- using `obsType: 'nucleus'` to more accurately refer to observations from [single-nucleus](https://doi.org/10.1038/nmeth.4407) experiments (similarly `obsType: 'nucleolus'`, `obsType: 'mitochondria'`, etc. as technologies for [isolating subcellular components](https://doi.org/10.1002/smll.202005793) mature)
- using `featureType: 'isoform'` to more accurately refer to features from [isoform-resolved](https://doi.org/10.1038/s41587-022-01231-3) sequencing- and FISH-based experiments
